...
import { DADATA_APY_KEY, DADATA_URL_TOKEN } from "src/app/config.API";
...
export class DadataInterceptorService implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    if (req.method.toLowerCase().toLocaleLowerCase() === "get") {
    ...
    const reqJson = req.clone({
      ...
      setHeaders: {
        ...
        Authorization: "Bearer 3c7cc8f0f42dd84ccdb730c9795ea343aa8ba46a",
